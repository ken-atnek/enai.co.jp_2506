...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
	...
	// **ヘッダー作成**
	$header_from = 'From: "' . mb_encode_mimeheader($name, 'ISO-2022-JP') . '" <no-reply@enai.co.jp>' . "\r\n";
	...
	// **送信**
	$rslt = mb_send_mail($send_target, $subject, $mail_body, $header_from, "-fno-reply@enai.co.jp");
	// **エンコーディングを元に戻す**
